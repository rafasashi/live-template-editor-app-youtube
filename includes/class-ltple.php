...
class LTPLE_App_Youtube {

	/**
	 * The single instance of LTPLE_App_Youtube.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function __construct ( $file='', $parent, $version = '1.0.0' ) {
		...
		$this->settings = new LTPLE_App_Youtube_Settings( $this->parent );
		
		$this->admin = new LTPLE_App_Youtube_Admin_API( $this );
		...
		$apps = $this->parent->apps->get_terms( 'app-type', array(
			...
			'youtube' => array(
				...
				'options' 	=> array(
					...
					'thumbnail' => $this->assets_url . 'youtube.jpg',
	...
	/**
	 * Main LTPLE_App_Youtube Instance
	 *
	 * Ensures only one instance of LTPLE_App_Youtube is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see LTPLE_App_Youtube()
	 * @return Main LTPLE_App_Youtube instance
	 */
