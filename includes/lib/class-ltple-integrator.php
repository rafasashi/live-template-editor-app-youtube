...
class LTPLE_Integrator_Youtube extends LTPLE_Client_Integrator {
			...
			if( isset($this->parameters['key']) ){
				...
				if( !empty($this->parameters['value'][$goo_api_project]) && !empty($this->parameters['value'][$goo_consumer_key]) && !empty($this->parameters['value'][$goo_consumer_secret]) ){
					...
					$message = '<div class="alert alert-danger">';
						...
						$message .= 'Sorry, youtube is not yet available on this platform, please contact the dev team...';
	...
	public function appConnect(){
		...
		elseif(isset($_REQUEST['code'])){
			...
			$message = '<div class="alert alert-success">';
				...
				$message .= 'Congratulations, you have successfully connected a Youtube account!';
